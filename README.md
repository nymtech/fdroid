...
2. To add the repository, click "SCAN QR CODE" and scan the QR code below or add the repository manually with the following URL:
    ...
    ```
    https://media.githubusercontent.com/media/nymtech/fdroid/refs/heads/main/fdroid/repo?fingerprint=06C095C54BBFE147C986FD29ADF4E9BCD5E95ECACD6D865C6045B66B0B5500FB
    ```

    <p align="center">
      <img src="./qrcode.png" alt="F-Droid repo QR code" width="300" height="300"/>
    </p>
